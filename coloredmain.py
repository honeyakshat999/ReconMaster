...
css={"blue":"\x1b[34m","black":"\x1b[30m","cyan":"\x1b[36m","green":"\x1b[32m","magenta":"\x1b[35m","red":"\x1b[31m","white":"\x1b[37m","yellow":"\x1b[33m","reset":"\x1b[39m","bright":"\x1b[1m","dim":"\x1b[2m","normal":"\x1b[22m","reset_all":"\x1b[0m"}
logo=f"""{css['green']+css['bright']}
   __                                          _            
...
def removeDups(filename):
        with open(filename, 'r+') as file:
            ...
            for line in set(lines):
                file.write(line)
        print(f"\n{css['green']+css['bright']}The data has been saved to {filename} {css['reset']}")
...
if(args.engine == 'all'):
    ...
    print(f"\n{css['red']+css['bright']}wrong parameter values!!!{css['reset']}")
